...
import { mockProducts } from './component/mockData';
  ...
  return (
    <div className="container mx-auto px-4 py-6">
        <div className="flex items-center text-gray-600 mb-6">
          ...
          <span className="text-[#D6A985]">กล่องสุ่ม/Box Set</span>
        </div>
        ...
        <div className="mb-4">
          <div className="flex items-center px-2 mb-3">
            ...
            <span className="text-[#B86A4B] font-bold text-[28px]">กล่องสุ่ม/Box Set</span>
