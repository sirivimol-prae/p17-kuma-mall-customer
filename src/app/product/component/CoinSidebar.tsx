...
import { coinCardData } from '../../account/mycoin/component/cardData';
import { coinCardImages } from '../../account/mycoin/component/cardImages'

const CoinSidebar = () => {
  const displayedCoins = coinCardData.slice(0, 4);
      ...
      <div className="space-y-3 flex flex-col items-start">
        {displayedCoins.map((coin) => (
          <div key={coin.id} className="w-[235px] flex flex-col">
            <Link href={`/account/mycoin/${coin.id}`} className="w-full">
              <div className="flex flex-col hover:opacity-90 transition-opacity duration-300">
                <div className="border border-[#D6A985] rounded-lg p-2 mb-2 hover:shadow-md transition-shadow duration-300">
                  <div className="relative w-[215px] h-[170px] flex items-center justify-center">
                    <Image 
                      src={coinCardImages[coin.id as keyof typeof coinCardImages]} 
                      alt={coin.title} 
                      fill
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center gap-2 mb-1">
                    <p className="text-[26px] font-bold text-[#B86A4B]">
                      ฿{parseInt(coin.price).toLocaleString()}
                    </p>
                  ...
                  <div className="flex items-center text-[18px] text-gray-500">
                    <span>ใช้ได้ก่อน 31/12/2025</span>
